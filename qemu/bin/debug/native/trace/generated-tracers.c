...
TraceEvent *bin_debug_native_trace_events[] = {
...
static void trace_bin_debug_native_register_events(void)
{
    trace_event_register_group(bin_debug_native_trace_events);
}
trace_init(trace_bin_debug_native_register_events)
